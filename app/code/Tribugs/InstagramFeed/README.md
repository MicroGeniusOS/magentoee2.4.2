...
You just need to add a module "Tribugs/InstgramFeed"
...
**Instagram Feed Widget **support store admin in updating trendy eye-catching Instagram images on any specific pages on your store site.
...
From the **Admin Panel**, go to `Store > Settings > Configuration > TRIBUGS EXTENSIONS > Instagram Feed`
...
- **Creating Instagram API guideline**: see [Here]
...
- In **Layout Updates** section, you can click **Add Layout Update** to set the layout.
  - In the **Display on** field, select the [category], [product], or [page] where the block will be shown. 
