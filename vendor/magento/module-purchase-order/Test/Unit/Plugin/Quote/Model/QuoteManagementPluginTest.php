...
class QuoteManagementPluginTest extends TestCase
{
    ...
    /**
     * @var \Magento\Quote\Api\Data\CartExtensionInterface|MockObject
     */
    ...
    /**
     * @var \Magento\NegotiableQuote\Model\Quote\History|MockObject
     */
    ...
    protected function setUp(): void
    {
        ...
        $this->quoteExtensionAttributes = $this->createMock(\Magento\Quote\Api\Data\CartExtensionInterface::class);
        $this->negotiableQuoteHistory = $this->createMock(\Magento\NegotiableQuote\Model\Quote\History::class);
