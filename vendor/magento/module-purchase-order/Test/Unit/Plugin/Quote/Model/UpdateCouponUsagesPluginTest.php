...
class UpdateCouponUsagesPluginTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        $this->quote = $this->getMockBuilder(Quote::class)
            ...
            ->setMethods(['getAppliedRuleIds', 'setAppliedRuleIds'])
            ->getMock();
    ...
    public function testBeforeExecute()
    {
        ...
        $this->rule->expects($this->at(0))->method('getRuleId')->willReturn(10);
        $this->rule->expects($this->at(1))->method('getRuleId')->willReturn(12);
        $this->updateCouponUsagesPlugin->beforeExecute($this->updateCouponUsages, $this->quote, 1);
    }
}
