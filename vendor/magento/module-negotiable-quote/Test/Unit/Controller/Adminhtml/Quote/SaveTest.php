...
class SaveTest extends TestCase
{
    ...
    {
        $this->resource = $this->getMockBuilder(RequestInterface::class)
        ...
        $this->resource->expects($this->at(1))->method('getParam')->with('quote')->willReturn([]);
    ...
    public function testExecute()
    {
        ...
        $this->resource->expects($this->at(4))->method('getParam')->with('delFiles')->willReturn('1,2');
