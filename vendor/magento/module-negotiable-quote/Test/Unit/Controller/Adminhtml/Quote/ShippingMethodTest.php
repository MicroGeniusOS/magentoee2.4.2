...
class ShippingMethodTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->resource->expects($this->at(0))->method('getParam')->with('quote_id')->willReturn(1);
        ...
        $resultRaw->expects($this->any())->method('setContents')->willReturn($resultRaw);
        $resultRawFactory->expects($this->any())->method('create')->willReturn($resultRaw);
    ...
    {
        $this->resultFactory->expects($this->atLeastOnce())->method('create')->willReturn($this->page);
        $this->mockQuote();
