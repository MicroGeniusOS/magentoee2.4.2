...
class NegotiableQuoteConverterTest extends TestCase
{
    ...
    /**
     * @var NegotiableQuoteItemInterfaceFactory|PHPUnitFrameworkMockObjectMockObject
     */
    ...
    protected function setUp(): void
    {
        ...
        $this->extensionFactory = $this->getMockBuilder(ExtensionAttributesFactory::class)
            ...
            ->setMethods(['create'])
            ->getMock();
        $this->cartItemFactory = $this->getMockBuilder(CartItemInterfaceFactory::class)
            ->disableOriginalConstructor()
            ->setMethods(['create'])
            ->getMock();
        $this->negotiableQuoteItemFactory = $this->getMockBuilder(
            NegotiableQuoteItemInterfaceFactory::class
        )
            ->disableOriginalConstructor()
            ->setMethods(['create'])
            ->getMock();
    ...
    public function testArrayToQuote()
    {
        ...
        $itemsCollection = $this->getMockBuilder(Collection::class)
            ->disableOriginalConstructor()
