...
class UpdateConfigTest extends TestCase
{
    ...
    {
        $this->companyStatusService = $this->getMockForAbstractClass(StatusServiceInterface::class);
        ...
        $this->configResourceMock = $this->getMockForAbstractClass(ConfigInterface::class);
