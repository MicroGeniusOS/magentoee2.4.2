...
class CartValidationTest extends TestCase
{
     ...
     */
    public function testExecuteWithoutListId()
    {
     ...
     */
    public function testExecuteWithInvalidRequestPreconditions()
    {
        $productData = '{"sku": "someExistentProduct", "qty": 2}';
        $productDataDecoded = new DataObject(json_decode($productData, true));
     ...
     */
    public function testExecuteWithNonExistentProduct()
    {
     ...
     */
    public function testExecuteWithNonExistentRequisitionList()
    {
     ...
     */
    public function testExecuteWithSimpleExistentProduct()
    {
        $productData = '{"sku": "somethingExistent", "qty": 2}';
     ...
     */
    public function testExecuteWithRequestedProductExistentInRequisitionList()
    {
        $productData = '{"sku": "somethingExistent", "qty": 2}';
     ...
     */
    public function testExecuteWithRequestedProductAbsentInRequisitionList()
    {
        $productData = '{"sku": "somethingExistent", "qty": 2}';
     ...
     * @return array
     */
    public function userFriendlyErrorMessageOutputDataProvider()
    {
        return [
            [
                'List Name',
